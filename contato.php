...
<body>
<section class="page-banner mt-5 p-5">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="contact-form form-style-four mt-2">
                    <form action="#">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-input mt-15">
                                    ...
                                    <div class="input-items default">
                                        ...
                                        <input type="text" placeholder="endereco@email.com">
                                    </div>
                                </div> <!-- form input -->
                            </div>
                            <div class="col-md-6">
            ...
            <div class="col-lg-4 col-md-6 col-sm-8">
                <div class="section-title mt-5 pb-20">
...
<script src="https://kit.fontawesome.com/9c7a9a6bb5.js"></script>
